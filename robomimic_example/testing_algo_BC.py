# Description: This file is used to test the Behavior Cloning (BC) algorithm on the RoboMimic dataset for the Lift task.
...
WS_DIR = os.path.dirname(os.path.realpath(__file__))
